...
<head>
	...
	<title><?php echo $admin->admin_level_nama ?> -
...
<body>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu" role="menu">
							<li role="presentation">
								<a href="<?php echo base_url();?>user/edit-password" role="menuitem">
			...
			<div>
				<div>
					<ul class="site-menu">
						...
						<li class='site-menu-item'>
							<a href='<?php echo base_url();?>website/goods' class='animsition-link'>
						...
						<li class='site-menu-item has-sub'>
							...
							<ul class='site-menu-sub'>
								<li class='site-menu-item'>
									<a href='<?php echo base_url();?>website/incoming' class='animsition-link'>
								...
								<li class='site-menu-item'>
									<a href='<?php echo base_url();?>website/outgoing' class='animsition-link'>
										<i class='site-menu-icon fa fa-angle-right'></i>
										<span class='site-menu-title'>
										Outgoing Goods
										</span>
								...
								<li class='site-menu-item'>
									<a href='<?php echo base_url();?>website/adjustment' class='animsition-link'>
										<i class='site-menu-icon fa fa-angle-right'></i>
										<span class='site-menu-title'>
											Adjustment
										</span>
						...
						<li class='site-menu-item has-sub'>
							...
							<ul class='site-menu-sub'>
								<li class='site-menu-item'>
									<a href='<?php echo base_url();?>website/incoming-report' class='animsition-link'>
										<i class='site-menu-icon fa fa-angle-right'></i>
										<span class='site-menu-title'>
										Incoming Goods
										</span>
								...
								<li class='site-menu-item'>
									<a href='<?php echo base_url();?>website/outgoing-report' class='animsition-link'>
										<i class='site-menu-icon fa fa-angle-right'></i>
										<span class='site-menu-title'>
										Outgoing Goods
										</span>
								...
								<li class='site-menu-item'>
									<a href='<?php echo base_url();?>website/adjustment-report' class='animsition-link'>
										<i class='site-menu-icon fa fa-angle-right'></i>
										<span class='site-menu-title'>
										 Adjustment
										</span>
						...
						<li class='site-menu-item has-sub'>
							...
							<ul class='site-menu-sub'>
								...
								<li class='site-menu-item'>
									<a href='<?php echo base_url();?>website/user' class='animsition-link'>
										<i class='site-menu-icon fa fa-angle-right'></i>
										<span class='site-menu-title'>
											System Users
										</span>
						...
						<?php if($admin->admin_level_kode === '1' || $admin->admin_level_kode === '2'):?>
						<li class='site-menu-item'>
							<a href='<?php echo base_url();?>backup' class='animsition-link'>
								<i class='site-menu-icon fa fa-database'></i>
								<span class='site-menu-title'>
								Backup Database
								</span>
							</a>
	...
	<script>
		$('#modal-konfirmasi').on('show.bs.modal', function (event) {
			...
			modal.find('#hapus-barang').attr("href", "<?php echo site_url();?>website/goods/hapus/" + id);
			modal.find('#hapus-masuk').attr("href", "<?php echo site_url();?>website/incoming/hapus/" + id);
			modal.find('#hapus-keluar').attr("href", "<?php echo site_url();?>website/outgoing/hapus/" + id);
			modal.find('#hapus-penyesuaian').attr("href", "<?php echo site_url();?>website/adjustment/hapus/" + id);
		});
	</script>
