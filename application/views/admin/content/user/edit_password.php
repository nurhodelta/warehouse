            ...
            <div class="col-md-12">
                <div class="panel rounded-0">
                    ...
                    <div class="panel-body container-fluid">
                        <form action="<?php echo site_url();?>user/edit_password/<?php echo $admin_user;?>" method="post" enctype="multipart/form-data" id="exampleStandardForm"
                            autocomplete="off">
                            ...
                            <div class='button center'>
                                <input class="btn btn-success btn-sm" type="submit" name="simpan" value="Save Data" id="">
                            </div>
                        </form>
                    </div>
                </div>
