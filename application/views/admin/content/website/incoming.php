...
<?php if ($action == 'view' || empty($action)){ ?>
				...
				<div class="col-md-12">
					<div class="panel rounded-0">
						...
						<div class="panel-body container-fluid table-detail">
									...
									<form action="" method="post" id="form">
										...
										<div class='btn-navigation'>
											<div class='pull-right'>
												<a class="btn btn-success" href="<?php echo site_url();?>website/incoming"><i class="fa fa-refresh"></i></a>
											</div>
										</div>
									</form>
								</div>
									...
									<div class="paging">
										<div id='pagination'>
											<div class='pagination-right'>
												<ul class="pagination">
													<?php if ($jml_halaman > 1) { echo pages($halaman, $jml_halaman, 'website/incoming/view', $id=""); }?>
												</ul>
											</div>
										</div>
									</div>
                            ...
                            <?php if ($admin->admin_level_kode == 1) { ?>
		<a href="<?php echo site_url();?>website/incoming/add">
	...
	<div class="page">
				...
				<div class="col-md-12">
					<div class="panel rounded-0">
						...
						<div class="panel-body container-fluid">
							<form action="<?php echo site_url();?>website/incoming/add" method="post" id="exampleStandardForm" autocomplete="off">
								...
								<div class='button center'>
									...
									<input class="btn btn-danger btn-sm" type="reset" name="batal" value="Cancel" onclick="location.href='<?php echo site_url(); ?>website/incoming'"
									/>
								</div>
							</form>
						</div>
		...
		<a href="<?php echo site_url();?>website/incoming">
			<button class="site-action btn-raised btn btn-sm btn-floating blue" type="button">
