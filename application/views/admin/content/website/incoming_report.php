    ...
    series: [{
        ...
        data: [
			...
			<?php } ?>
						...
						<a href="<?php echo base_url();?>website/incoming-report-pdf" class="btn btn-success btn-block btn-lg" style="margin-top: 30px !important;" target="_blank">Download Incoming Goods Report PDF</a>
                </div>
            </div>
        </div>
    </div>
