                        ...
                        <div class="table-full table-view">
                                ...
                                <form action="" method="post" id="form">
                                    ...
                                    <div class='btn-navigation'>
                                        <div class='pull-right'>
                                            <a class="btn btn-success" href="<?php echo site_url();?>website/goods"><i class="fa fa-refresh"></i></a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            ...
                            <?php if ($admin->admin_level_kode == 1) { ?>
                                            <td class="text-center action">
                                                <a class="btn-update" href="<?php echo site_url();?>website/goods/edit/<?php echo $row->id_barang;?>">
                                ...
                                <div class="paging">
                                    <div id='pagination'>
                                        <div class='pagination-right'>
                                            <ul class="pagination">
                                                <?php if ($jml_halaman > 1) { echo pages($halaman, $jml_halaman, 'website/goods/view', $id=""); }?>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <?php if ($admin->admin_level_kode == 1) { ?>
    <a href="<?php echo site_url();?>website/goods/add">
...
<div class="page">
            ...
            <div class="col-md-12">
                <div class="panel rounded-0">
                    ...
                    <div class="panel-body container-fluid">
                        <form action="<?php echo site_url();?>website/goods/add" method="post" id="exampleStandardForm" autocomplete="off">
                            ...
                            <div class='button center'>
                                ...
                                <input class="btn btn-danger btn-sm" type="reset" name="batal" value="Cancel" onclick="location.href='<?php echo site_url(); ?>website/goods'"
                                />
                            </div>
                        </form>
                    </div>
    ...
    <a href="<?php echo site_url();?>website/goods">
		<button class="site-action btn-raised btn btn-sm btn-floating blue" type="button">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel rounded-0">
                    ...
                    <div class="panel-body container-fluid">
                        <form action="<?php echo site_url();?>website/goods/edit/<?php echo $id_barang;?>" method="post" id="exampleStandardForm" autocomplete="off">
