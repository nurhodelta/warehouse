...
<?php if ($action == 'view' || empty($action)){ ?>
				...
				<div class="col-md-12">
					<div class="panel rounded-0">
						...
						<div class="panel-body container-fluid table-detail">
									...
									<form action="" method="post" id="form">
										...
										<div class='btn-navigation'>
											<div class='pull-right'>
												<a class="btn btn-success" href="<?php echo site_url();?>website/outgoing"><i class="fa fa-refresh"></i></a>
											</div>
										</div>
									</form>
								</div>
                            ...
                            <?php if ($admin->admin_level_kode == 1) { ?>
		<a href="<?php echo site_url();?>website/outgoing/add">
	...
	<div class="page">
		...
		<a href="<?php echo site_url();?>website/outgoing">
			<button class="site-action btn-raised btn btn-sm btn-floating blue" type="button">
