    ...
    series: [{
        ...
        data: [
			...
			<?php } ?>
                ...
                </div><a href="<?php echo base_url();?>website/outgoing-report-pdf" class="btn btn-success btn-block btn-lg" style="margin-top: 30px !important;" target="_blank">Download PDF Outgoing Goods Report</a>
            </div>
        </div>
    </div>
    </div>
